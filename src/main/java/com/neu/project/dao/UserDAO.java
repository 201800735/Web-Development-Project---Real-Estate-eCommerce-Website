...
public class UserDAO extends DAO {
    ...
    public User create(String username, String password, String firstName, String lastName, String emailId, String userType, String street, String city, String state, String zip)
            throws AdException {
        try {
            begin();
    ...
    public User update(String username, String password, String firstName, String lastName, String emailId, String userType, String street, String city, String state, String zip, User user) throws AdException {
        try {
            begin();
