	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<form:form class="form-horizontal" action="adduser.htm" commandName="user" method="post" name="myForm">
					...
					<div class="control-group">
						...
						<div class="controls">
							<td><form:input path="email" size="30" onkeyup="ready()"/> <font color="red"><form:errors path="email"/></font></td>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Username:</label>
						<div class="controls">
							<td><form:input path="name" id="name" size="30" onkeyup="return checkUsername()"/> <span class="span6" id="success"></span> <font color="red"><form:errors path="name"/></font></td>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Password:</label>
						<div class="controls">
							<td><form:password path="password" size="30" name="userPass" onkeyup="validate()"/>Strength: <span class="span6" id="mylocation"><strong>No Strength</strong></span> <font color="red"><form:errors path="password"/></font></td>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<td>
            					<form:radiobutton class="checkbox-inline" path="userType" value="Buyer" label="Buyer"  checked="true"/> 
            					<form:radiobutton class="checkbox-inline" path="userType" value="Seller" label="Seller" />
        					</td>
						</div>
					</div>
					<div class="control-group">
